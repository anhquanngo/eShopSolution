...
namespace eShopSolution.Data.Migrations.Extenstions
{
    public static class ModelBuiderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
           ...
           new Product()
           {
            ...
            // any guid
            var roleId = new Guid("A17D61E2-B8F0-42B4-8693-504EE2A44A5A");
            ...
            modelBuilder.Entity<AppUser>().HasData(new AppUser
            {
                ...
                Email = "anhquandemo@gmail.com",
                NormalizedEmail = "anhquandemo@gmail.com",
                EmailConfirmed = true,
